...
const nextConfig: NextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_SHOPIFY_VR_GLASSES_VARIANT_ID: process.env.NEXT_PUBLIC_SHOPIFY_VR_GLASSES_VARIANT_ID,
    NEXT_PUBLIC_SHOPIFY_LICENSE_VARIANT_ID: process.env.NEXT_PUBLIC_SHOPIFY_LICENSE_VARIANT_ID,
  },
